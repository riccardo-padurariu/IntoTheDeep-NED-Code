 ...
 */
@Config
public class SampleMecanumDriveTeleOp extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(18, 0, 0.7);//15 1.2
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(18, 0, 0.5);//16.8 1.1

    public static double LATERAL_MULTIPLIER = 1.8;//2.30769
