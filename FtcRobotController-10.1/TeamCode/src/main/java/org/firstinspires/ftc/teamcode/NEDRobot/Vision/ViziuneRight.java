...
@Config
public class ViziuneRight extends OpenCvPipeline {
    /*
    YELLOW  = Parking Left
    CYAN    = Parking Middle
    ...
    public static int LEFTSIDE_REGION_X = 170;
    public static int LEFTSIDE_REGION_Y = 920;

    public static int CENTRAL_REGION_X = 1050;
    public static int CENTRAL_REGION_Y = 850;

    public static int RIGHTSIDE_REGION_X = 1850 ;
    public static int RIGHTSIDE_REGION_Y = 900;
