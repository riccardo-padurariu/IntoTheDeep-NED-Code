...
@Config
public class Viziune extends OpenCvPipeline {
    /*
    YELLOW  = Parking Left
    CYAN    = Parking Middle
    ...
    public static int LEFTSIDE_REGION_Y = 820;

    public static int CENTRAL_REGION_X = 1500;
    public static int CENTRAL_REGION_Y = 790;

    public static int RIGHTSIDE_REGION_X = 2350;
