...
@Config
public class ViziuneREDLeft extends OpenCvPipeline {
    /*
    YELLOW  = Parking Left
    CYAN    = Parking Middle
    ...
    public static int LEFTSIDE_REGION_X = 620;
    public static int LEFTSIDE_REGION_Y = 800;

    public static int CENTRAL_REGION_X = 1450;
    public static int CENTRAL_REGION_Y = 800;

    public static int RIGHTSIDE_REGION_X = 2290;
    public static int RIGHTSIDE_REGION_Y = 850;
